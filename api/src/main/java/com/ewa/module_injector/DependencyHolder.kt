...
abstract class DependencyHolder8<
    ...
    companion object {
        operator fun <
            ...
            api7: A7,
            api8: A8,
            block: (BaseDependencyHolder<D>, A1, A2, A3, A4, A5, A6, A7, A8) -> D
        ): BaseDependencyHolder<D> {
            return object : DependencyHolder8<A1, A2, A3, A4, A5, A6, A7, A8, D>(
                api1 = api1,
                api2 = api2,
                api3 = api3,
                api4 = api4,
...
abstract class DependencyHolder9<
    ...
    companion object {
        operator fun <
            ...
            api8: A8,
            api9: A9,
            block: (BaseDependencyHolder<D>, A1, A2, A3, A4, A5, A6, A7, A8, A9) -> D
        ): BaseDependencyHolder<D> {
            return object : DependencyHolder9<A1, A2, A3, A4, A5, A6, A7, A8, A9, D>(
                api1 = api1,
                api2 = api2,
                api3 = api3,
                api4 = api4,
...
abstract class DependencyHolder10<
    ...
    companion object {
        operator fun <
            ...
            api9: A9,
            api10: A10,
            block: (BaseDependencyHolder<D>, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10) -> D
        ): BaseDependencyHolder<D> {
            return object : DependencyHolder10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, D>(
                api1 = api1,
                api2 = api2,
                api3 = api3,
                api4 = api4,
